...
void s::on_ajouterpersonnel_clicked()
{
     ...
     for(int i = 0; i < id.length(); i++){
       ...
       QString departement = ui->departement->currentText();
        ...
        QString prenom= ui->prenom->text();
          ...
          if((id == "") or (departement=="")or(datenaiss=="")or (dateemb=="") or (salairpersotest=="") or (nom=="") or (prenom==""))
          {
              verif =1 ;
              QMessageBox::information(nullptr, QObject::tr("Erreur"),
...
void s::on_pushButton_supp_clicked()
{
 ...
 void s::on_ajouterconge_clicked()
 {
            ...
            QString numbers = "0123456789";
             ...
             QString datedebut = ui->datedebut->date().toString();
               QString datefin = ui->datefin->date().toString();
                  ...
                  bool verif = false;
               if((reftest == "") or (id_p=="")or(datedebut=="")or (datefin==""))
               {
                   verif =1 ;
                   QMessageBox::information(nullptr, QObject::tr("Erreur"),
                               QObject::tr("Erreur CHAMP VIDE .\n"
 ...
 void s::on_modifierconge_clicked()
 {
     bool verif_ref,verif_idp;
    verif_ref=true;
    verif_idp=true;
         ...
         QString numbers = "0123456789";
           for(int i = 0; i < refcongetest.length(); i++){
            ...
            QString id_p= ui->id_p_2->currentText();
             ...
             bool verif = false;
          if((refcongetest == "") or (id_p=="")or(datedebut=="")or (datefin==""))
          {
              verif =1 ;
              QMessageBox::information(nullptr, QObject::tr("Erreur"),
                          QObject::tr("Erreur CHAMP VIDE .\n"
 ...
 void s::on_supprimerconge_clicked()
 {
 ...
 void s::on_ajouterdepartement_clicked()
 {
 ...
 void s::on_modifierdepartement_clicked()
 {
     //int nb;
     bool verif_num,verif_nomd;
    verif_num=true;
 ...
 void s::on_supprimerdepartement_clicked()
 {
     bool verif_num;
    verif_num=true;
    bool test1 = false;
...
void s::on_chercherconge_clicked()
{
...
void s::on_chercherdepart_clicked()
{
...
void s::on_personnel1_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_conge1_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_departement1_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}


void s::on_pushButton_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);
}

void s::on_pushButton_2_clicked()
{
    ui->stackedWidget->setCurrentIndex(2);
}

void s::on_pushButton_3_clicked()
{
    ui->stackedWidget->setCurrentIndex(3);
}

void s::on_pushButton_4_clicked()
{
    ui->stackedWidget->setCurrentIndex(4);
}

void s::on_personnel2_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}


void s::on_conge2_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_departement2_2_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}


void s::on_pushButton_18_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);
}

void s::on_pushButton_21_clicked()
{
    ui->stackedWidget->setCurrentIndex(2);
}


void s::on_pushButton_17_clicked()
{
    ui->stackedWidget->setCurrentIndex(4);
}


void s::on_pushButton_22_clicked()
{
    ui->stackedWidget->setCurrentIndex(3);
}

void s::on_pushButton_25_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}


void s::on_pushButton_26_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}


void s::on_pushButton_49_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_27_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);
}


void s::on_pushButton_29_clicked()
{
    ui->stackedWidget->setCurrentIndex(2);
}

void s::on_pushButton_31_clicked()
{
    ui->stackedWidget->setCurrentIndex(4);
}


void s::on_pushButton_30_clicked()
{
    ui->stackedWidget->setCurrentIndex(3);
}

void s::on_pushButton_37_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_35_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_50_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_39_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);
}

void s::on_pushButton_36_clicked()
{
    ui->stackedWidget->setCurrentIndex(2);
}

void s::on_pushButton_40_clicked()
{
    ui->stackedWidget->setCurrentIndex(4);
}

void s::on_pushButton_32_clicked()
{
    ui->stackedWidget->setCurrentIndex(3);
}

void s::on_pushButton_84_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_85_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_130_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_89_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);
}

void s::on_pushButton_88_clicked()
{
    ui->stackedWidget->setCurrentIndex(2);
}

void s::on_pushButton_87_clicked()
{
    ui->stackedWidget->setCurrentIndex(4);
}

void s::on_pushButton_83_clicked()
{
    ui->stackedWidget->setCurrentIndex(3);
}

void s::on_pushButton_14_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_9_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_47_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_13_clicked()
{
    ui->stackedWidget->setCurrentIndex(6);
}

void s::on_pushButton_10_clicked()
{
    ui->stackedWidget->setCurrentIndex(7);
}

void s::on_pushButton_12_clicked()
{
    ui->stackedWidget->setCurrentIndex(8);
}

void s::on_pushButton_11_clicked()
{
    ui->stackedWidget->setCurrentIndex(9);
}

void s::on_pushButton_90_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_91_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_128_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_92_clicked()
{
    ui->stackedWidget->setCurrentIndex(6);
}

void s::on_pushButton_94_clicked()
{
    ui->stackedWidget->setCurrentIndex(7);
}

void s::on_pushButton_96_clicked()
{
    ui->stackedWidget->setCurrentIndex(9);
}

void s::on_pushButton_95_clicked()
{
    ui->stackedWidget->setCurrentIndex(8);
}

void s::on_pushButton_102_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_98_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_129_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_100_clicked()
{
    ui->stackedWidget->setCurrentIndex(6);
}

void s::on_pushButton_99_clicked()
{
    ui->stackedWidget->setCurrentIndex(7);
}

void s::on_pushButton_103_clicked()
{
    ui->stackedWidget->setCurrentIndex(9);
}

void s::on_pushButton_97_clicked()
{
    ui->stackedWidget->setCurrentIndex(8);
}

void s::on_pushButton_109_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_105_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_131_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_107_clicked()
{
    ui->stackedWidget->setCurrentIndex(6);
}

void s::on_pushButton_106_clicked()
{
    ui->stackedWidget->setCurrentIndex(7);
}

void s::on_pushButton_110_clicked()
{
    ui->stackedWidget->setCurrentIndex(9);
}

void s::on_pushButton_104_clicked()
{
    ui->stackedWidget->setCurrentIndex(8);
}

void s::on_pushButton_116_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_112_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_132_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_114_clicked()
{
    ui->stackedWidget->setCurrentIndex(6);
}

void s::on_pushButton_113_clicked()
{
    ui->stackedWidget->setCurrentIndex(7);
}

void s::on_pushButton_117_clicked()
{
    ui->stackedWidget->setCurrentIndex(9);
}

void s::on_pushButton_111_clicked()
{
    ui->stackedWidget->setCurrentIndex(8);
}

void s::on_pushButton_276_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_275_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_277_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_278_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_279_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_280_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_227_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_230_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_229_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_220_clicked()
{
    ui->stackedWidget->setCurrentIndex(13);
}

void s::on_pushButton_226_clicked()
{
    ui->stackedWidget->setCurrentIndex(14);
}

void s::on_pushButton_222_clicked()
{
    ui->stackedWidget->setCurrentIndex(15);
}

void s::on_pushButton_224_clicked()
{
    ui->stackedWidget->setCurrentIndex(16);
}

void s::on_pushButton_238_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_237_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_236_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_235_clicked()
{
    ui->stackedWidget->setCurrentIndex(13);
}

void s::on_pushButton_232_clicked()
{
    ui->stackedWidget->setCurrentIndex(14);
}

void s::on_pushButton_233_clicked()
{
    ui->stackedWidget->setCurrentIndex(16);
}

void s::on_pushButton_223_clicked()
{
    ui->stackedWidget->setCurrentIndex(15);
}

void s::on_pushButton_241_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_244_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_242_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_240_clicked()
{
    ui->stackedWidget->setCurrentIndex(13);
}

void s::on_pushButton_243_clicked()
{
    ui->stackedWidget->setCurrentIndex(14);
}

void s::on_pushButton_246_clicked()
{
    ui->stackedWidget->setCurrentIndex(16);
}

void s::on_pushButton_245_clicked()
{
    ui->stackedWidget->setCurrentIndex(15);
}

void s::on_pushButton_250_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_249_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_257_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_254_clicked()
{
    ui->stackedWidget->setCurrentIndex(13);
}

void s::on_pushButton_255_clicked()
{
    ui->stackedWidget->setCurrentIndex(14);
}

void s::on_pushButton_253_clicked()
{
    ui->stackedWidget->setCurrentIndex(16);
}

void s::on_pushButton_251_clicked()
{
    ui->stackedWidget->setCurrentIndex(15);
}

void s::on_pushButton_259_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_258_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_266_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_263_clicked()
{
    ui->stackedWidget->setCurrentIndex(13);
}

void s::on_pushButton_264_clicked()
{
    ui->stackedWidget->setCurrentIndex(14);
}

void s::on_pushButton_262_clicked()
{
    ui->stackedWidget->setCurrentIndex(16);
}

void s::on_pushButton_260_clicked()
{
    ui->stackedWidget->setCurrentIndex(15);
}

void s::on_pushButton_24_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void s::on_pushButton_23_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void s::on_pushButton_48_clicked()
{
    ui->stackedWidget->setCurrentIndex(12);
}

void s::on_pushButton_221_clicked()
{
     ui->stackedWidget->setCurrentIndex(11);
}

void s::on_pushButton_225_clicked()
{
    statistique4 S ;
            S.exec();
}
