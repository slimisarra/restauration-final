...
private slots:
    ...
    void on_pushButton_1250_clicked();

    void on_pushButton_1248_clicked();

    void on_label_10_linkActivated(const QString &link);

    void on_label_8_linkActivated(const QString &link);

    void on_pushButton_1252_clicked();

    void on_pushButton_1251_clicked();

    void on_pushButton_1238_clicked();

    void on_pushButton_1253_clicked();
